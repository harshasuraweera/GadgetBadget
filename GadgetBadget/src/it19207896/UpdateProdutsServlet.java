...
/**
 * Servlet implementation class UpdateProdutsServlet
 */
@WebServlet("/UpdateProdutsServlet")
public class UpdateProdutsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateProdutsServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Queries_2.updateProducts(connection,productId,title, sDesc, lDesc, price, downloadLink,feturedImage);
