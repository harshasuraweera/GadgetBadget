...
<body>
    ...
    <div></div>
    <div class="wrapper">
        <div class="sidebar" data-color="purple" data-image="" style="background-image:url(&quot;assets/assets_tharu/img/sidebar-5.jpg&quot;);">
            <div class="sidebar-wrapper">
                <div class="logo"><a class="simple-text" href="#">sales dashboard</a></div>
                <ul class="nav">
                    <li class="active" style="width: 160px;height: 70px;"><a class="active" href="index.html"><i class="fa fa-home"></i><p>Home Page
</p></a></li>
                    <li class="active" style="width: 160px;height: 70px;"><a href="my-store.html"><i class="fa fa-th"></i>
    <p>My Store
    </p>
</a></li>
                    <li class="active" style="width: 160px;height: 70px;"><a href="add-products.html" style="height: 40px;font-size: 13px;font-family: 'Titillium Web', sans-serif;text-align: left;">ADD PRODUCT<i class="fa fa-plus"></i></a></li>
                </ul>
                <ul class="nav">
                    <li class="active" style="width: 250px;height: 600px;"><img style="width: 250px;height: 600px;" src="assets/assets_tharu/img/Grand%20re-opening%20SALE.png"></li>
                </ul>
            </div>
        </div>
        <div class="main-panel">
            <nav class="navbar navbar-light navbar-expand-md">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1" style="width: 400px;color: var(--purple);">
                        <ul class="navbar-nav">
                            <li class="nav-item"></li>
                        </ul>
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-plus"></i>&nbsp; Create New Store</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
            <div>
                <h1 style="text-align: center;font-size: 30px;color: var(--purple);">Current Sales Status</h1>
            </div>
            <div><input type="text" class="form-control-plaintext" value="Seller's Name: " readonly style="text-align: center;width: 500px;color: var(--secondary);font-size: 20px;" /></div>
            <div class="content">
                <div class="container">
                    <div class="card" id="TableSorterCard">
                        <div class="row table-topper align-items-center">
                            <div class="col-4 text-left" style="margin: 0px;padding: 5px 15px;"><button class="btn btn-warning btn-sm" id="zoom_in" type="button" zoomclick="ChangeZoomLevel(-10);" style="padding: 5px;margin: 2px;"><i class="fa fa-search-plus"></i></button><button class="btn btn-warning btn-sm" id="zoom_out" type="button" zoomclick="ChangeZoomLevel(-10);" style="padding: 5px;margin: 2px;"><i class="fa fa-search-minus"></i></button></div>
                                    ...
                                    <table class="table table tablesorter" id="ipi-table">
                                        <thead class="thead-dark">
                                            <tr style="border-style: solid;">
                                                <th style="border-style: solid;width: 200px;text-align: center;">ID</th>
                                                <th style="border-style: solid;width: 226.4;text-align: center;">Product</th>
                                                <th style="border-style: solid;width: 200px;text-align: center;">Total Sales</th>
                                                <th class="sorter-false" style="border-style: solid;width: 200px;text-align: center;">current Total Amount</th>
                                                <th class="filter-false sorter-false" style="border-style: solid;width: 200px;text-align: center;">Payment Method</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr style="font-size: 12px;border-style: solid;">
                                                <td style="border-style: solid;">1</td>
                                                <td style="border-style: solid;"><br><br><br></td>
                                                <td style="border-style: solid;"><br><br><br></td>
                                            ...
                                            <tr style="font-size: 12px;border-style: solid;">
                                                ...
                                                <td style="border-style: solid;"><br><br><br></td>
                                                <td style="border-style: solid;"><br><br></td>
                                                <td style="border-style: solid;"></td>
                                                <td style="border-style: solid;"><br><br><br></td>
                                            </tr>
                                            <tr style="font-size: 12px;border-style: solid;">
    ...
    <footer class="footer-basic">
        <div class="social" style="text-align: center;"><a href="#"><i class="icon ion-social-instagram"></i></a><a href="#"><i class="icon ion-social-snapchat"></i></a><a href="#"><i class="icon ion-social-twitter"></i></a><a href="#"><i class="icon ion-social-facebook"></i></a></div>
