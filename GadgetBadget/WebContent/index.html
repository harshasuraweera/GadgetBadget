...
<script src="https://threejs.org/examples/js/libs/stats.min.js"></script>
            ...
            <div class="container center-vertically-holder" style="margin-top:-20px;">
                <div class="row center-vertically">
                    <div class="col-md-8 offset-sm-0 offset-md-2 text-center" style="margin-top:100px;margin-bottom:100px;">
                        ...
                        <p><a class="btn btn-primary" role="button" href="#" style="border-color: var(--indigo);background: var(--blue);">Get Start Now</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div>
        <div class="container">
            <div class="row product-list dev" style="margin-top: 40px;">
                <div class="col-sm-6 col-md-4 product-item animation-element slide-top-left">
                    <div class="product-container">
                        <div class="row">
                            <div class="col-md-12"><a class="product-image" href="https://evox.lk/" target="_blank"><img src="assets/assets_tharu/img/iphone6.jpg"></a></div>
                        </div>
                        <div class="row">
                            <div class="col-8">
                                <h2><a href="#">iPhone 6s</a></h2>
                            </div>
                            <div class="col-4"><a class="small-text" href="#">Ceza Store</a></div>
                        </div>
                        <div class="product-rating"><a class="text-left small-text" href="#" style="margin-left: 0;">82 Sales</a></div>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-6"><button class="btn btn-light" type="button" style="background: var(--indigo);">Add to Cart</button></div>
                                    <div class="col-6">
    ...
    <div style="text-align: center;margin-top: 40px;"><a class="btn btn-primary" role="button" style="background: var(--indigo);" href="products.html"><strong>See More</strong></a></div>
