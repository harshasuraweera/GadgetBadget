        ...
        <div class="container">
            <form class="search-form">
                <div class="input-group" style="height: 38px;">
                    <div class="input-group-prepend"><span class="input-group-text" style="height: 38px;"><i class="fa fa-search"></i></span></div><input class="form-control" type="text" placeholder="I am looking for..">
                    <div class="input-group-append" style="height: 38px;"><button class="btn btn-light" type="button" style="height: 38px;background: var(--indigo);color: var(--white);margin-right: 0;margin-bottom: 0;margin-left: 0;">Search </button></div>
                </div>
            </form>
